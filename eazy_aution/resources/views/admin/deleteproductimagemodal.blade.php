<div class="modal-header">
  ...
  {!! Form::open(array('url' =>'admin/deleteImageForm', 'name'=>'deleteImageForm', 'id'=>'deleteImageForm', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
  ...
  <div class="modal-footer">
	...
	<button type="button" class="btn btn-primary" id="deleteProductImage">{{ trans('labels.Delete') }}</button>
  </div>
  {!! Form::close() !!}
</div>